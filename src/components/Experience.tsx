...
const Experience = () => {
  const experiences = [
    {
      ...
      type: "Engineering",
      description:
        "Working on microservices-based architecture with Java, Spring Boot, and React, focusing on scalability, performance optimization, and cloud infrastructure.",
      achievements: [
    ...
    },
    {
      ...
      type: "Engineering",
      description:
        "Contributed to microservices development using Java, Spring Boot, and frontend technologies while gaining hands-on experience with AWS cloud services.",
      achievements: [
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      case "Education":
        return "bg-skill-ai/20 text-skill-ai border-skill-ai/30";
      case "Retail":
        return "bg-skill-web/20 text-skill-web border-skill-web/30";
      case "Leadership":
        return "bg-skill-cpp/20 text-skill-cpp border-skill-cpp/30";
      default:
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Building leadership skills and practical experience across
            education, retail, and customer service while developing technical
            expertise.
          </p>
        </div>
          ...
          <div className="space-y-12">
            {experiences.map((exp, index) => (
              ...
              >
                ...
                {/* Content Card */}
                <Card
                  className={`gradient-card p-8 flex-1 group hover:scale-105 transition-all duration-300 ${
