...
const Hero = () => {
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-32 right-32 w-16 h-16 bg-accent/20 rounded-full animate-float"
        style={{ animationDelay: "2s" }}
      ></div>
      <div
        className="absolute top-1/2 left-10 w-12 h-12 bg-primary-glow/20 rounded-full animate-float"
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Social Links */}
          <div
            className="flex justify-center space-x-6 mt-8 animate-fade-in"
